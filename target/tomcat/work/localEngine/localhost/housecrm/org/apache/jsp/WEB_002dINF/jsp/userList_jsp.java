...
public final class userList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
      ...
      out.write("<title>隆基泰和房屋管理</title>\r\n");
	...
	+ request.getContextPath() + "/");
      ...
      out.write("\t\t\t\t<h1 class=\"page-header\" align=\"center\">用户信息列表</h1>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<!-- /.col-lg-12 -->\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- /.row -->\r\n");
      ...
      out.write("\t\t\t\t\t<a class=\"btn btn-info\" onclick=\"turnToAddUser()\">新增用户</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"col-xs-2\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" id=\"name\" name=\"name\" class=\"form-control\" placeholder=\"姓名\"/>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<button class=\"btn btn-success\" onclick=\"searchUser()\">查询</button>\r\n");
      out.write("\t\t\t<br>\r\n");
      out.write("\t\t\t<div class=\"col-lg-12\">\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div class=\"modal fade\" id=\"addUser\" tabindex=\"-1\" role=\"dialog\" \r\n");
      ...
      out.print(path);
      out.write("/user/addUser\" method=\"post\" id=\"addUserForm\">\r\n");
      out.write("\t\t\t\t         \t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t\t\t\t登录名：<input type=\"text\" class=\"form-control\" name=\"username\" placeholder=\"姓名拼音\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t密码：<input type=\"text\" class=\"form-control\"  name=\"userpassword\" placeholder=\"姓名拼音作为密码\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t性别：<input type=\"text\" class=\"form-control\"  name=\"usersex\" placeholder=\"性别\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t姓名：<input type=\"text\" class=\"form-control\"  name=\"usercardname\" placeholder=\"姓名\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t身份证：<input type=\"text\" class=\"form-control\"  name=\"usercard\" placeholder=\"身份证\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t电话：<input type=\"text\" class=\"form-control\"  name=\"userphone\" placeholder=\"电话\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t地址：<input type=\"text\" class=\"form-control\"  name=\"useraddr\" placeholder=\"地址\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t         </div>\r\n");
      out.write("\t\t\t\t         <div class=\"modal-footer\">\r\n");
      out.write("\t\t\t\t            <button type=\"button\" class=\"btn btn-default\" \r\n");
      out.write("\t\t\t\t               data-dismiss=\"modal\">关闭\r\n");
      out.write("\t\t\t\t            </button>\r\n");
      out.write("\t\t\t\t            <button type=\"button\" class=\"btn btn-primary\" onclick=\"submitAddUser()\">\r\n");
      out.write("\t\t\t\t             \t\t添加\r\n");
      out.write("\t\t\t\t            </button>\r\n");
      out.write("\t\t\t         \t</div>\r\n");
      out.write("\t\t\t         \t</form>\r\n");
      ...
      out.write("\t\t\t         \t<form action=\"");
      out.print(path);
      out.write("/user/updateUser\" method=\"post\" id=\"updateUser\">\r\n");
      out.write("\t\t\t\t         \t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t         \t\t<input type=\"hidden\" id=\"userId\" name=\"userid\" value=\"\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t姓名：<input type=\"text\" class=\"form-control\" id=\"userCardname\" name=\"usercardname\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t电话：<input type=\"text\" class=\"form-control\" id=\"userPhone\" name=\"userphone\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t状态：\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select id=\"userState\" name=\"userstate\" class=\"form-control\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"0\">在职</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\">离职</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t地址：<input type=\"text\" class=\"form-control\" id=\"userAddr\" name=\"useraddr\" value=\"\"/>\r\n");
      out.write("\t\t\t\t\t         </div>\r\n");
      out.write("\t\t\t\t         <div class=\"modal-footer\">\r\n");
      out.write("\t\t\t\t            <button type=\"button\" class=\"btn btn-default\" \r\n");
      out.write("\t\t\t\t               data-dismiss=\"modal\">关闭\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div class=\"modal fade\" id=\"deleteUser\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"del_hint_title\" aria-hidden=\"true\">\r\n");
      out.write("\t\t\t   <div class=\"modal-dialog\">\r\n");
      out.write("\t\t\t\t      <div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t         <div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t            <button type=\"button\" class=\"close\" data-dismiss=\"modal\"  aria-hidden=\"true\">× </button>\r\n");
      out.write("\t\t\t\t            <h4 class=\"modal-title\" id=\"del_hint_title\">\r\n");
      out.write("\t\t\t\t              \t删除!!谨慎操作!!\r\n");
      out.write("\t\t\t\t            </h4>\r\n");
      out.write("\t\t\t\t         </div>\r\n");
      out.write("\t\t\t\t         \r\n");
      out.write("\t\t\t\t         <div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t           \t删除后，将不会看到此人的一些重要信息，是否删除？\r\n");
      out.write("\t\t\t\t           \t<input type=\"hidden\" id=user_State name=\"user_State\" value=\"\"/>\r\n");
      out.write("\t\t\t\t         </div>\r\n");
      out.write("\t\t\t\t         <div class=\"modal-footer\">\r\n");
      out.write("\t\t\t\t            <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">关闭\r\n");
      out.write("\t\t\t\t            </button>\r\n");
      out.write("\t\t\t\t            <button type=\"button\" onclick=\"confirmNo1()\" class=\"btn btn-danger\">\r\n");
      out.write("\t\t\t\t           \t\t   删除\r\n");
      out.write("\t\t\t\t            </button>\r\n");
      out.write("\t\t\t\t         </div>\r\n");
      out.write("\t\t\t\t      </div><!-- /.modal-content -->\r\n");
      ...
      out.write("\t    \t    columns: [\r\n");
      out.write("\t    \t              {title: 'userId',field: 'userid',align: 'center',valign: 'middle',visible:false}, \r\n");
      out.write("\t\t                  {title: '员工姓名',field: 'usercardname',align: 'center',valign: 'middle',width:'100px'}, \r\n");
      out.write("\t\t                  {title: '电话',field: 'userphone',  align: 'center',valign: 'middle',width:'100px'},\r\n");
      out.write("\t\t                  {title: '性别',field: 'usersex',align: 'center',valign: 'middle',width:'100px'},\r\n");
      out.write("\t\t                  {title: '身份证',field: 'usercard',align: 'center',valign: 'middle',width:'200px'},\r\n");
      out.write("\t\t                  {title: '家庭住址',field: 'useraddr',align: 'center',valign: 'middle',width:'200px'},\r\n");
      out.write("\t\t                  {field:'operate', title:'操作',align:'center',width:'80px',\r\n");
      out.write("\t\t\t               \t   formatter:function(value, row, index){\r\n");
      out.write("\t\t\t               \t\tvar a = '<i style=\"cursor:hand;\" class=\"glyphicon glyphicon-cog\"  onclick=\"confirmYes(\\''+row.userid+'\\')\"></i>';\r\n");
      out.write("\t\t\t               \t\tvar c = '<span>   </span>';\r\n");
      out.write("\t\t\t               \t    var b = '<i style=\"cursor:hand;\" class=\"glyphicon glyphicon-trash\"  onclick=\"confirmNo(\\''+row.userid+'\\')\"></i>';\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t    \r\n");
      out.write("\t    function turnToAddUser(){\r\n");
      ...
      out.write("\t    \r\n");
      out.write("\t    /**跳转到个人详情页面 **/\r\n");
      out.write("\t    function confirmYes(id){\r\n");
      out.write("\t    \tvar url='");
      out.print(path);
      out.write("/user/personalInfo/'+id;\r\n");
      out.write("\t    \t$.ajax({\r\n");
      out.write("\t    \t\t   type: \"POST\",\r\n");
      out.write("\t    \t\t   url: url,\r\n");
      ...
      out.write("\t    \t\t\t   //ID传过去很重要，否则会新添加一条数据\r\n");
      out.write("\t    \t\t\t   $(\"#userId\").val(id);\r\n");
      out.write("\t    \t\t\t   $(\"#userCardname\").val(data.usercardname);\r\n");
      out.write("\t    \t\t\t   $(\"#userPhone\").val(data.userphone);\r\n");
      out.write("\t    \t\t\t   $(\"#userState\").val(data.userstate);\r\n");
      out.write("\t    \t\t\t   $(\"#userAddr\").val(data.useraddr);\r\n");
      ...
      out.write("\t    \tvar $state = $('#userState option:selected').val();\r\n");
      out.write("\t    \t$(\"#updateUser\").submit();\r\n");
      out.write("\t    }\r\n");
      out.write("\t    \r\n");
      out.write("\t    function confirmNo(userId){\r\n");
      out.write("\t    \t$(\"#user_State\").val(userId);\r\n");
      out.write("\t    \t$('#deleteUser').modal({\r\n");
      out.write("\t\t\t      keyboard: true\r\n");
      out.write("\t\t   });\r\n");
      out.write("\t    }\r\n");
      out.write("\t    \r\n");
      out.write("\t    \r\n");
      out.write("\t    /**删除用户 实际上 改变状态为2**/\r\n");
      out.write("\t    function confirmNo1(){\r\n");
      out.write("\t    \tvar userId = $(\"#user_State\").val();\r\n");
      out.write("\t    \tvar url='");
      out.print(path);
      out.write("/user/deleteUser/'+userId;\r\n");
      out.write("\t    \t$.ajax({\r\n");
      out.write("\t    \t\t   type: \"POST\",\r\n");
      out.write("\t    \t\t   url: url,\r\n");
      out.write("\t    \t\t   async : false,\r\n");
      out.write("\t    \t\t   success: function(msg){\r\n");
      out.write("\t    \t\t\t //\t$(\"#\"+userId).hide();\r\n");
      ...
      out.write("\t\t    \turl = '");
      out.print(path);
      out.write("/user/userReflush/'+name;\r\n");
      out.write("\t    \t}\r\n");
